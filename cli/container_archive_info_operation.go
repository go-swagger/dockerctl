...
func parseOperationContainerContainerArchiveInfoResult(resp0 *container.ContainerArchiveInfoOK, respErr error) (string, error) {
	if respErr != nil {
		...
		resp1, ok := iResp1.(*container.ContainerArchiveInfoBadRequest)
		if ok {
		...
		resp2, ok := iResp2.(*container.ContainerArchiveInfoNotFound)
		if ok {
		...
		resp3, ok := iResp3.(*container.ContainerArchiveInfoInternalServerError)
		if ok {
...
func registerModelContainerArchiveInfoBadRequestBodyFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {
	...
	if err := registerContainerArchiveInfoBadRequestBodyAnonContainerArchiveInfoBadRequestBodyAO1Message(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerContainerArchiveInfoBadRequestBodyAnonContainerArchiveInfoBadRequestBodyAO1Message(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelContainerArchiveInfoBadRequestBodyFlags(depth int, m *container.ContainerArchiveInfoBadRequestBody, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	...
	err, messageAdded := retrieveContainerArchiveInfoBadRequestBodyAnonContainerArchiveInfoBadRequestBodyAO1MessageFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveContainerArchiveInfoBadRequestBodyAnonContainerArchiveInfoBadRequestBodyAO1MessageFlags(depth int, m *container.ContainerArchiveInfoBadRequestBody, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
